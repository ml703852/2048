...
def print_board(game_board: List[List[int]]) -> None:
    """
...
def generate_piece(game_board: List[List[int]], user_input: bool = False) -> Dict[str, int]:
    """
    Generates a value and coordinates for the next number to be placed on the board.
    Will raise an error if the provided board is full.
    : param game_board: a 4x4 2D list of integers representing a game of 2048
